...
require 'Controller2/storeData2.php';
?>
  <div class="container">
<div class="div">
<div class="b">
<legend>REGISTRATION</legend>                 
  ...
  <input type="text" id="type" name="type" onkeyup="checkType()" onblur="checkType()">
  <span class="error" id="typeErr"> <?php echo $typeErr;?></span><hr>

   <label for="doctor_fee">Doctor Fee :</label>
  <input type="text" id="doctor_fee" name="doctor_fee" onkeyup="checkDoctorFee()" onblur="checkDoctorFee()">
  <span class="error" id="doctor_feeErr"> <?php echo $doctor_feeErr;?></span><hr>
