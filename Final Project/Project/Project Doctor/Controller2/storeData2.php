...
if (isset($_SESSION['name'])){}
  ...
  {  $name = $email = $mobile_number = $shift = $address = $password = $confirm_password = $gender = $category = $dob = $encrypted_password = $type = $doctor_fee= '';}

$nameErr = $emailErr = $mobile_numberErr = $shiftErr =$addressErr = $passwordErr = $confirm_passwordErr = $genderErr = $categoryErr = $dobErr = $typeErr = $doctor_feeErr='';
$flag=1;
$update="on";  
...
{  
  ...
  else 
  {
    ...
    if (empty($_POST["doctor_fee"])) 
  {
    $doctor_feeErr = "Doctor Fee Required";
    $flag=0;
    $update="off";
  } 
  else 
  {
    $doctor_fee = test_input($_POST["doctor_fee"]);
  }
