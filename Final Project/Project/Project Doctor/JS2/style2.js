...
function checkType()
{
    ...
    {
		document.getElementById("typrErr").innerHTML = "Type Required";
...
function checkDoctorFee()
{
    if (document.getElementById("doctor_fee").value == "") 
    {
		document.getElementById("doctor_feeErr").innerHTML = "Doctor Fee Required";
		document.getElementById("doctor_feeErr").style.color = "red";
		document.getElementById("doctor_fee").style.borderColor = "red";
	}	else
	{
		document.getElementById("doctor_feeErr").innerHTML = "";
		document.getElementById("doctor_fee").style.borderColor = "black";
	}
}
...
function search(id) //for appointment
{
	...
	else 
	{
    	...
    	xhttp.open("GET", "Controller2/search2.php?id="+id, true);
   		xhttp.send();
...
function searchPrescription(id) //for prescription
{
	...
	if (id == "") 
    {
    	...
    	xhttp.open("GET", "Controller2/searchPrescription2.php?id="+id, true);
   		xhttp.send();
