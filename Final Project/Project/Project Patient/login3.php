...
<?php 
session_start();
if (isset($_SESSION['name'])){header("location:welcome3.php");}
else{require 'Bar3/top3.php';}
require 'controller3/loginCheck3.php';
?>
  <div class="container">
<div class="div">
<form name="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" >
 <div class="b">
  ...
  <input type="submit" value="Submit"><a href="forgotPassword3.php">Forgot Password?</a>
